            ...
            <footer className={style.footerContainer}>
                <div className={style.footerContainer__wrapper}>
                    ...
                    <div className={style.footerContainer__wrapper__icons}>
                        <a className={style.footerContainer__wrapper__icons__a} href='https://www.linkedin.com/in/oliwier-markiewicz-47857228a/' target='_blank' rel='noreferrer'>
                        ...
                        <a className={style.footerContainer__wrapper__icons__a} href='https://github.com/ol1mowski' target='_blank' rel='noreferrer'>
