...
const Project = props => {
    ...
    return (
        <>
        { props.reverse ? <div id={style.reverse} className={style.projectWrapper}>
                ...
                <div className={style.projectWrapper__descriSection}>
                    ...
                    <div className={style.projectWrapper__iconSection}>
                        <a href={props.github} target='_blank' rel='noreferrer' className={style.projectWrapper__iconSection__a}>
                        ...
                        <a href={props.page} target='_blank' rel='noreferrer' className={style.projectWrapper__iconSection__a}>
                            <div className={style.projectWrapper__iconSection__icon}>
                                <span className={style.projectWrapper__iconSection__icon__span}>
                                    Live Demo
                                </span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="tabler-icon tabler-icon-external-link"><path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6"></path><path d="M11 13l9 -9"></path><path d="M15 4h5v5"></path></svg>
                            </div>
                        </a>
                    </div>
                </div>
